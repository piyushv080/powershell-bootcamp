...
## This scripts check the server Avrg CPU and Memory utlization along with   
## disk utilization,Paging Size,Performance counter 
################################################################################ 
$Outputreport=""
#Declaring CSS
...
$Outputreport += "</table></BODY></HTML>"
$Outputreport | out-file C:\Script\Windows_Server_Health_Status.html